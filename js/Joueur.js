class Joueur extends ElementHtml{
     ...
     * @param {JQuery<HTMLElement>} $vies L'élément HTML des vies
     ...
     */
    constructor($raquette,$score, $vies ,$boutonMonte,$boutonDescend){
        super($raquette);
        /**
        ...
        this.$score=$score;
         /**
         * L'endroit où on va écrire les vies du joueur
         * @type {JQuery<HTMLElement>}
         */
        this.$vies=$vies;
        /**
     ...
     * @param {Number} PV Les points gagnés
     */
    incrementeVies(PV){
        this.vies-=PV;
        this._effetVies();
        this.$vies.text(this.vies);
    }
    /**
    ...
    /**
     * Effet visuel qui se produit quand on perds des vies
     * @private
     */
    _effetVies(){
        ElementHtml.effetCss(this.$vies,"flush");
    }
